...
<?php echo $this->Form->create('Galeria'); ?>
	<fieldset>
		<legend><?php echo __('Edit Galeria'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Galeria.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Galeria.id'))); ?></li>
